...
<body>
    ...
    <div class="main_header">
        ...
        <div class="search_bar">
            <input class="search_input" placeholder="I'm searching for..." type="text" name="keyword"/>
            <div class="category_index">
                <p class="category">所有分类</p>
            </div>
        ...
        <div class="left_layout">
            ...
            <ul>
                <li><img class="icon_20"><a class="cart_show" href="cart.json">Cart(${cart_count})</a></li>
                <li><img class="icon_21"><a class="wishlist_show" href="wishlist.json">Wish List(${wishlist_count})</a></li>
                <li class="login_in"><img class="icon_22"><a class="user" href="login_actionLogin.json">Login In</a></li>
                <li class="login_out"><img class="icon_22"><a class="user" >Login Out</a></li>
            </ul>
...
<a href="/admin/main.do">进入后台管理系统</a>--%>
